                    ...
                    <div class="col-lg-7" style="padding-bottom:120px; margin-left: 115px;">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="txtmaMonAn" placeholder="Nhập mã món ăn..." />
                            </div>
                             <div class="form-group">
                                <label>Tên món ăn</label>
                                <input class="form-control" name="txttenMonAn" placeholder="Nhập tên món ăn..." />
                            </div>
                            <div class="form-group">
                                <label>Giá bán</label>
                                <input class="form-control" name="txtgiaBan" placeholder="" />
                            </div>
                            <div class="form-group">
