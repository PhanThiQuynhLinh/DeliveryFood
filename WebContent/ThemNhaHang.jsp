                    ...
                    <div class="col-lg-7" style="padding-bottom:120px; margin-left: 115px;">
                        <form action="" method="POST">
                            <div class="form-group">
                                ...
                                <input class="form-control" name="txttenDangNhap" placeholder="Nhập tên đăng nhập..." />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control" name="txtreMatKhau" placeholder="Nhập lại mật khẩu..." />
                            </div>
                             <div class="form-group">
                                <label>Tên nhà hàng</label>
                                <input class="form-control" name="txttenNhaHang" placeholder="Nhập tên nhà hàng..." />
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="txtloaiNhaHang" placeholder="" />
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-default">Thêm nhà hàng</button>
