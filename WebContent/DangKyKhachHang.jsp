				...
				<div class="thanhvien">
					...
					<div class="thongtincanhan">
						...
						<div class="grid name">
							...
							<input class="address" type="text" name="tenKhachHang" placeholder="Nhập Tên.." required="required">
						</div>
						<div class="grid email">
							<p class="add-info">Email: </p>
							<input class="address" type="email" name="email" placeholder="Nhập email.." required="required">
							<p style="color: red;"><bean:write name="dangKyKhachHangForm" property="thongBao"/></p>
						</div>
						...
						<div class="grid sex" >
							...
							<div class = "gioiTinh">
							<input class="address" type="radio" name="gioiTinh" style="width: 15px;" value = "0"> Nam
							<input class="address" type="radio" name="gioiTinh" style="width: 15px;" value = "1"> Nữ
						</div><br>
						</div>
						<div class="grid namect">
							<p class="add-info">Mật Khẩu: </p>
							<input class="address" type="password" name="matKhau" placeholder="Nhập Mật Khẩu.." required="required">
						</div>
						<div class="grid namect">
							<p class="add-info">Ngày Sinh: </p>
							<input class="address" type="date" name="ngaySinh" required="required" >
						</div>
						<div class="grid namect">
							<p class="add-info">Nhập Lại Mật Khẩu: </p>
							<input class="address" type="password" name="" placeholder="Nhập Mật Khẩu.." required="required" >
						</div>
					...
					<div class="ttdiachi">
						<p class="ttdiachi">Thông tin địa chỉ</p>
							<div class="grid phone">
								<p class="add-info">Địa Chỉ: </p>
								<input class="address" type="text" name="diaChi" required="required" placeholder="Nhập Địa Chỉ..." >
							</div>
							<div class="grid phone">
								<p class="add-info">Quận: </p>
								<html:select property="maKhuVuc" styleClass="form-control" name="dangKyKhachHangForm">
						...
						<center>
					<div class="hoantat"><!-- 
							<a href="index.html" class="button" name = >Hoàn Tất</a> -->
							<input type="submit" name = "submit" value = "submit" class = "button">
							<%-- <html:link action="/dang-ky-khach-hang" styleClass="button" >Hoàn Tất</html:link> --%>
					</div></center>
